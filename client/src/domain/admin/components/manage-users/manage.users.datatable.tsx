...
import { DataTableUser, UpdateUsersRequest } from '../../types/admin.types';
import { RotateCcw } from 'lucide-react';
import { AppErrorCode, UserRole, getToastErrorMessage } from '../../../app';
import { updateUsers } from '../../api';
import toast from 'react-hot-toast';

interface ManageUsersDataTableProps {
  columns: ColumnDef<DataTableUser>[];
  data: DataTableUser[];
  reload: () => void;
  loading: boolean;
}

export function ManageUsersDataTable({
  columns,
  data,
  reload,
  loading,
