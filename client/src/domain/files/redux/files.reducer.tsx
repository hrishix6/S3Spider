...
import { BreadCrumb, DataTableBucket, DataTableFile, DataTableType, FilesState, defaultBreadcrumbs } from '../types';
import { handleBucketClickAsync, handleCrumbClickAsync, handleFolderClickAsync, loadBucketsAsync } from './files.async.actions';

const initialState: FilesState = {
  loading: false,
  error: false,
  breadCrumbs: defaultBreadcrumbs,
  currentBucket: "col-environment",
...
const filesSlice = createSlice({
  ...
  reducers: {
        ...
        setAfterBucketClick: (state, action: PayloadAction<{bucket: DataTableBucket, files: DataTableFile[], newCrumb: BreadCrumb}>)=> {
    ...
    extraReducers: (builder)=> {
        builder.addCase(handleCrumbClickAsync.pending,(state)=> {
            state.loading = true;
...
export const {addBreadCrumb, setBreadCrumbs,setDatatableType, setDatatableBuckets, setDatatableFiles, setAfterBucketClick} = filesSlice.actions;
