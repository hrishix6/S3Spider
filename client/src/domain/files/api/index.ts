...
export async function renameFile(
  ...
  try {
    ...
    const q = new URLSearchParams(params).toString();
    const client = getClient();
    await client.put(`s3/${accountId}/files?${q}`, payload);
    return true;
  } catch (error) {
    throw handleAxiosError(error);
  }
...
export async function copyFile(
  ...
  try {
    ...
    const q = new URLSearchParams(params).toString();
    const client = getClient();
    await client.post(`s3/${accountId}/files?${q}`, payload);
    return true;
  } catch (error) {
    throw handleAxiosError(error);
  }
...
export async function moveFile(
  ...
  try {
    ...
    const q = new URLSearchParams(params).toString();
    const client = getClient();
    await client.post(`s3/${accountId}/files/mv?${q}`, payload);
    return true;
  } catch (error) {
    throw handleAxiosError(error);
  }
...
export async function deleteFile(
  ...
  try {
    const client = getClient();
    await client.post(`s3/${accountId}/files/rm`, {
      bucket: bucketId,
      keys: [key],
      region,
    });
...
export async function deleteFolder(
  ...
  try {
    ...
    await client.delete(`s3/${accountId}/folders?${q}`);
    return true;
  } catch (error) {
    throw handleAxiosError(error);
  }
...
export async function createFolder(
  ...
  try {
    ...
    await client.post(`s3/${accountId}/folders?${q}`, body);
    return true;
  } catch (error) {
    throw handleAxiosError(error);
  }
